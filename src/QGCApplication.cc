...
void QGCApplication::_initCommon(void)
{
    ...
    qmlRegisterUncreatableType<XBStationManager>    ("XBStation.XBStationManager",          1, 0, "XBStationManager",           kRefOnly);
    qmlRegisterUncreatableType<XBVideoProvider>     ("XBStation.XBVideoProvider",           1, 0, "XBVideoProvider",            kRefOnly);
