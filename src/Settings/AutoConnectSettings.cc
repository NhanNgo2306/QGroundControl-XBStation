...
DECLARE_SETTINGSFACT(AutoConnectSettings, xbUsername)
DECLARE_SETTINGSFACT(AutoConnectSettings, xbPermission)
DECLARE_SETTINGSFACT(AutoConnectSettings, xbConnectionType)
DECLARE_SETTINGSFACT(AutoConnectSettings, xbToken)
DECLARE_SETTINGSFACT(AutoConnectSettings, xbFirmIP)
