...
Item {
    ...
    Rectangle {
            ...
            anchors.left: isHidden ? popupPIP.right : pip.right
  ...
  //          width: 0.8*dpi
            ...
            Rectangle {
                        ...
                        XBQuickSettings {
                            width: parent.width
                            height: parent.height
                            onShowXBSettingsDialog: pip.showXBSettingsDialog();
                        }
            }
    }
    Image {
    ...
    Image {
        id:             settingPip
        source:         xb_quick_setting.visible ? "/qmlimages/pipSettingHide.svg" : "/qmlimages/pipSetting.svg"
        mipmap:         true
        fillMode:       Image.PreserveAspectFit
        anchors.right:   parent.right
        anchors.bottom: parent.bottom
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                xb_quick_setting.visible = !xb_quick_setting.visible
                if(xb_quick_setting.visible) XBStationManager.prepare();
            }
        }
    }
//    BUTTON XBSETTING
    Rectangle {
        ...
        Image {
            ...
            height:             parent.height * 0.75
            sourceSize.height:  height
            source:         xb_quick_setting.visible ? "/qmlimages/btnXBClose.svg" : "/qmlimages/btnXBOpen.svg"
            mipmap:             true
            fillMode:           Image.PreserveAspectFit
            anchors.verticalCenter:     parent.verticalCenter
            anchors.horizontalCenter:   parent.horizontalCenter
