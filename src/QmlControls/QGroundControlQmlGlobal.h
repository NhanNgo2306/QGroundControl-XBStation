...
public:
    ...
    Q_PROPERTY(XBStationManager*    xbStationManager    READ xbStationManager       CONSTANT)
    ...
    XBStationManager*       xbStationManager    ()  { return _xbStationManager; }
...
private:
    ...
    XBStationManager*       _xbStationManager       = nullptr;
