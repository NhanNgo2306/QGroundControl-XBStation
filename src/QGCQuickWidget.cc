    ...
    QQuickWidget(parent)
{
    ...
    // XBStation Manager
    rootContext()->setContextProperty("XBStationManager", qgcApp()->toolbox()->xbStationManager());
    rootContext()->engine()->addImageProvider(QStringLiteral("XBVideoProvider"), qgcApp()->toolbox()->xbStationManager()->xbVideoProvider());

//    rootContext()->addI(QStringLiteral("XBVideoProvider"), qgcApp()->toolbox()->xbStationManager()->xbVideoProvider());
}
