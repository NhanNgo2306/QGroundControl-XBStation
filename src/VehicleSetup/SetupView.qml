...
Rectangle {
    ...
    function showDropboxController() {
        panelLoader.setSource("XBDropboxController.qml")
    }
...
//                setupComplete:      joystickManager.activeJoystick ? joystickManager.activeJoystick.calibrated : false
                ...
                onClicked: showDropboxController()
            }

//            ListElement {
//                buttonImage:        "/qmlimages/DropboxIcon"
//                buttonText:         qsTr("XBStation Dropbox")
//                pageSource:         "XBDropboxController.qml"
//            }
