...
QQmlApplicationEngine* QGCCorePlugin::createRootWindow(QObject *parent)
{
    ...
    pEngine->rootContext()->setContextProperty("XBStationManager", qgcApp()->toolbox()->xbStationManager());
    pEngine->rootContext()->engine()->addImageProvider(QStringLiteral("XBVideoProvider"), qgcApp()->toolbox()->xbStationManager()->xbVideoProvider());
